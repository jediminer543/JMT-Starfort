...
import org.jmt.starfort.ui.gui.input.InputEvent;
import org.jmt.starfort.ui.gui.util.GUIColour;
import org.jmt.starfort.ui.gui.util.GUIText;

public class Button extends WidgetInteractable implements IWidgetBordered,IWidgetBackgrounded, IWidgetColoured {

	GUIText text;
	boolean border = false, background = false;
	Map<String, GUIColour> colours = new HashMap<>();
	
	public Button(String text, String font, float xPos, float yPos) {
